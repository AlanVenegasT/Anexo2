  ...
  <body >
    ...
    <div class="espaciotabladearriba"> 
        <table class="tablacompleta" style="width: 100%; ">
            ...
            <tr>
                <td style="font-size: 8px; text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6; width: 20%; font-size: 7px; text-align: justify; padding-top: 6px; padding-bottom: 6px; padding-left: 2px; padding-right: 2px; " >Emisiones de metano para el Año base (g/kg/t)</td>
                <td style="background-color: #FFFFFF; border-color: #A6A6A6; width: 30%;"> </td>



                <td rowspan="2" style="font-size: 8px;  text-align: center; line-height: 7px; background-color: #FFFFFF; border-color: #A6A6A6;  width: 15%; font-size: 7px; text-align: justify; " >Metodología de 
                cuantificación</td>
            ...
            <tr>
                <td style="background-color: #FFFFFF; border-color: #A6A6A6; font-size: 7px; text-align: center; line-height: 8px; font-size: 7px; text-align: justify; padding-top: 4px; padding-bottom: 4px; padding-left: 4px; padding-right: 4px;" >Emisiones de metano para las operaciones en pozos fuera del Año base (g/kg/t)</td>
    ...
    <tbody id="tabla-body" class="bodytablahojauno">
      ...
      <tr class="diseñocolumnahojados" >    <!-- Fila2 -->
        ...
        <div class="contenedortresopciones" >
          ...
          <div class="terceraopcion" >
            <label class="margendospx" ><input type="radio" name="estado">Otros <span class="paddingtrecepx"> especidicar</span></label>
          </div>
        </div>
      </td>
